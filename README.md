...
<p>I'm a Python developer specializing in backend development. I work with Django REST Framework (DRF) to build efficient APIs and authentication systems. I have experience designing databases with PostgreSQL and MySQL.
...
🚀 Tech Stack: Python | Django | DRF | PostgreSQL | MySQL
